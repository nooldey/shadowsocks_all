...
#   Intro:  http://xubiji.com/5680.html		     	     		   #
#=================================================================#
...
function download_files(){
	...
	if ! wget --no-check-certificate -O libsodium-1.0.12.tar.gz https://github.com/jedisct1/libsodium/releases/download/1.0.11/libsodium-1.0.12.tar.gz; then
